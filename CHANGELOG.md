...
| Feature | Filter collection notes instantly from popular tag chips or any global tag-tree node, including hierarchical child-tag matches and one-click clearing. | Pending |
