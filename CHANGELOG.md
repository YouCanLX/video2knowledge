...
| Type | Change | Commit |
| --- | --- | --- |
| Feature | Configure TTS speed and timeout, M4A export defaults, bitrate, sample rate, channels, and lyrics through runtime settings and temporary speech CLI overrides; accept unequal-duration WAV segments. | Pending |
...
| Improvement | Replace inherited and rule-derived knowledge tags with semantic tags generated by the configured LLM, preserving each Markdown file when tagging fails. | `9088871` |
