...
| Type | Change | Commit |
| --- | --- | --- |
| Feature | Configure TTS speed and timeout, M4A export defaults, bitrate, sample rate, channels, and lyrics through runtime settings and temporary speech CLI overrides; accept unequal-duration WAV segments. | `8c7a89f` |
