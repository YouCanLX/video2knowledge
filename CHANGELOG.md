...
| Bug fix | Version GUI static assets from their modification time so a refreshed page cannot pair the Knowledge tab with a stale, non-clickable script. | `333b776` |

### 2026-09-04

| Type | Change | Commit |
| --- | --- | --- |
| Feature | Create or update Light Player playlists by creator and collection through its song-transfer API. | `785db2a` |
