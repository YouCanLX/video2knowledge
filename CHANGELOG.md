...
| Improvement | Generate shorter canonical topic labels, reject malformed tag artifacts, and merge conservative near-duplicate tags across Markdown notes. | Pending |
